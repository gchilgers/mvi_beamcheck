...
EXPECTED_OUTPUT_RESPONSE = 2274400.81656049
EXPECTED_OUTPUT_DEVIATION = 0.340

# --- expected flatness metrics ---
EXPECTED_FLATNESS_RESPONSE_CAX = 2279127.15710274
EXPECTED_FLATNESS_RESPONSE_D1 = 2139018.23578294
EXPECTED_FLATNESS_RESPONSE_D2 = 2162542.22689521
EXPECTED_FLATNESS_RESPONSE_D3 = 2153745.20425309 
EXPECTED_FLATNESS_RESPONSE_D4 = 2133656.67049619
EXPECTED_FLATNESS = 0.942133

# --- expected beam quality metric ---
EXPECTED_BEAM_QUALITY_DEVIATION = 0.451
...
def test_output_deviation_example_image():
    ...
    assert result.output_deviation == pytest.approx(EXPECTED_OUTPUT_DEVIATION, abs=1e-3)
...
def test_beam_quality_deviation_example_image():
    ...
    assert result.beam_quality_deviation == pytest.approx(EXPECTED_BEAM_QUALITY_DEVIATION, abs=1e-3)
